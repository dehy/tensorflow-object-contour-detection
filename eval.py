...
flags.DEFINE_integer(
    "eval_crop_size", 480, "Image crop size [height, width] for evaluation."
)

flags.DEFINE_string("checkpoint", None, "The initial checkpoint in tensorflow format.")


flags.DEFINE_string("image_dir", None, "The Image Directory.")

flags.DEFINE_string(
    "save_preds", None, "Path to folder where predictions will be saved."
)

flags.DEFINE_string(
    "eval_text", None, "The Path to the text file containing names of Images and Labels"
